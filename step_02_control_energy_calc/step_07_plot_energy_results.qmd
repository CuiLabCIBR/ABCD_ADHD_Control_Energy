...
dir.create(subcortex_path, recursive = TRUE, showWarnings = FALSE)
...
fwrite(data.frame(energy_roi_avg[401:452]), paste0(subcortex_path, "/test_td_0y_energy_log.csv"), row.names = FALSE)
...
# Calculate network-average control energy (log-transformed)
energy_roi_avg <- log(colMeans(energy_real_roi))
fwrite(data.frame(energy_roi_avg[401:452]), paste0(subcortex_path, "/test_adhd_0y_energy_log.csv"), row.names = FALSE)
